...
namespace Launcher
{
    ...
    {
        private OperatingSystemGeneral _osGeneral;
        private OperatingSystem _os;
        private string _defaultDirectory;
        private string _secondaryDirectory;
        private string _userName;
        private string _osPathSeperator;
        public Computer()
        {
            ...
            {
                _osGeneral = OperatingSystemGeneral.MacOsx;
                _os = MacosNameEquivalence(platformVersion);
                _defaultDirectory = "/Users/" + _userName + "/Library/Application Support";
                _secondaryDirectory = null;
                _osPathSeperator = "/";
            }
            else if (platformId == PlatformID.Win32NT)
            {
                _osGeneral = OperatingSystemGeneral.Windows;
                _os = WindowsVersionEquivalence(platformVersion);
                _defaultDirectory = "C:\\" + _userName + "\\AppData\\Local";
                _osPathSeperator = "\\";
                _secondaryDirectory = "C:\\ProgramData\\";
            }
            else if (platformId == PlatformID.Unix)
            {
                _osGeneral = OperatingSystemGeneral.Linux;
                _os = OperatingSystem.Linux;
                _defaultDirectory = "~/.thunderbird";
                _osPathSeperator = "/";
            }
            else
            {
                _osGeneral = OperatingSystemGeneral.UnknownOperatingSystemGeneral;
                _os = OperatingSystem.UnkownOperatingSystem;
            }
        }

        public OperatingSystemGeneral Platform => _osGeneral;

        public OperatingSystem OperatingSystem => _os;

        public string DefaultDirectory => _defaultDirectory;

        public string BackupDirectory => _secondaryDirectory;

        public string UserName => _userName;

        public string OsPathSeperator => _osPathSeperator;
        ...
        public OperatingSystem MacosNameEquivalence(Version macOsVersion)
        {
            ...
            macosNameEquivalenceDictionary.Add(21, OperatingSystem.MMonterey);
        ...
        {
            return _osGeneral is OperatingSystemGeneral.Windows;
        }

        public bool IsMacOs()
        {
            return _osGeneral is OperatingSystemGeneral.MacOsx;
        }

        public bool IsLinux()
        {
            return _osGeneral is OperatingSystemGeneral.Linux;
        }
    }
}